...
/* harmony import */ var _cubic_bezier_154a53a5_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./cubic-bezier-154a53a5.js */ 8797);
...
let App = class {
  ...
  componentDidLoad() {
    ...
    {
      rIC( /*#__PURE__*/(0,_Users_matteomuller_Desktop_APPIDEE_SharedGallery_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
        ...
        if (typeof window !== 'undefined') {
          Promise.resolve(/*! import() */).then(__webpack_require__.bind(__webpack_require__, /*! ./keyboard-808e4e15.js */ 8022)).then(module => module.startKeyboardAssist(window));
        }
...
let Footer = class {
  constructor(hostRef) {
    ...
    this.setupFadeFooter = /*#__PURE__*/function () {
      var _ref2 = (0,_Users_matteomuller_Desktop_APPIDEE_SharedGallery_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (contentEl) {
        if (!contentEl) {
...
let Header = class {
  constructor(hostRef) {
    ...
    this.setupFadeHeader = /*#__PURE__*/function () {
      var _ref3 = (0,_Users_matteomuller_Desktop_APPIDEE_SharedGallery_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (contentEl, condenseHeader) {
        if (!contentEl) {
